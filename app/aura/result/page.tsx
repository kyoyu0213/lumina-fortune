      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        {result ? (
          <section className="space-y-4">
            <div className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/70 shadow-[0_24px_48px_-30px_rgba(120,104,66,0.45)] backdrop-blur-[2px]">
              ...
              <div className="relative aspect-square w-full bg-[linear-gradient(135deg,#fdf7e9,#f4ecdb)]">
                {result.image ? (
                  ...
                  <div className="flex h-full w-full flex-col items-center justify-center gap-2 text-center">
                    ...
                    <p className="text-sm tracking-[0.12em] text-[#b6a880]">イラストは準備中です</p>
                  </div>
                )}
                {result.secret ? (
              ...
              <div className="p-6 text-center sm:p-8">
                <p className="text-[11px] tracking-[0.3em] text-[#b6a880] uppercase">Your Aura Color</p>
                ...
                {result.reading ? null : (
                  <p className="mt-6 text-[15px] leading-7 text-[#8a7c5a]">この鑑定文は後ほど追加します。</p>
                )}
              </div>
            </div>
            ...
            {result.reading ? (
              <>
                <ReadingBlock title="概要" emoji="✨" text={result.reading.overview} />
                <ReadingBlock title="性格" emoji="🔮" text={result.reading.personality} />
                <ReadingBlock title="恋愛傾向" emoji="💕" text={result.reading.love} />
                <ReadingBlock title="才能と適職" emoji="🌟" text={result.reading.work} />
          ...
          <section className="rounded-[2rem] border border-white/70 bg-white/70 p-8 text-center shadow-[0_24px_48px_-32px_rgba(120,104,66,0.4)] backdrop-blur-[2px]">
            <h1 className="text-xl font-medium text-[#4a4030]">診断結果が見つかりませんでした</h1>
            <p className="mt-3 text-sm leading-7 text-[#6f6242]">
              もう一度、最初から診断してみてください。
            </p>

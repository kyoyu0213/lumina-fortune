      ...
      <div className="flex flex-col gap-6">
        ...
        <SectionCard>
          ...
          <div className="mt-5 space-y-4 text-[15px] leading-8 text-[#544c42] sm:text-base">
            ...
            <p>ここでご紹介するのは、私が信頼できると判断した、2つの電話鑑定の場所です。</p>
          </div>
        ...
        <SectionCard>
          ...
          <p className="mt-5 text-[15px] leading-8 text-[#544c42] sm:text-base">
            2つの場所をご紹介します。それぞれに役割があり、あなたのご相談の質によって合う場所が変わります。
          </p>
        </SectionCard>
        ...
        <SectionCard>
          <h2 className="text-center text-base font-medium tracking-[0.08em] text-[#5d513f] sm:text-lg">
            ✦ ルミナが2つを選ぶときに、大切にしたこと ✦
          </h2>
          <div className="mt-5 space-y-4 text-[15px] leading-8 text-[#544c42] sm:text-base">
            <p>
              正直に申し上げますと、電話占いの世界には、ルミナの世界観とは合わないと感じる場所も少なくありません。煽るような広告、不安を強める言葉、過剰な料金体系——そうしたものを避けて、私が2つを選ぶときに、大切にした基準があります。
            </p>
          </div>
          ...
          <p className="mt-5 text-[15px] leading-8 text-[#544c42] sm:text-base">
            2つの場所は、それぞれに性質が違います。けれど、この3つの基準はすべて満たしています。
          </p>
        </SectionCard>
        ...
        <SectionCard>
          ...
          <div className="mt-5 space-y-4 text-[15px] leading-8 text-[#544c42] sm:text-base">
            ...
            <p>
              ご紹介した2つの場所のうち、どちらを選ばれても構いません。あるいは、最初は試しに小さく、慣れてきたら本格的に、と段階を踏んで使い分けていただいても良いと思います。私が大切にしているのは、あなたが行き場のないまま夜を過ごさないこと。それだけです。
            </p>
            <p>

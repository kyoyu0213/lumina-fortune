...
const PROVIDERS: ReadonlyArray<{
  ...
  },
  {
    number: "3",
    name: "電話占いウィル",
    eyebrow: "一人では答えが見つからない夜に",
    body: [
      "恋愛、復縁、人間関係――。心の中では分かっているつもりでも、どうしても答えが見えなくなる夜があります。そんな時は、一人で抱え込まず、経験豊富な鑑定師に相談してみるのもひとつの選択です。",
      "電話占いウィルには、恋愛相談や復縁相談を得意とする鑑定師が多数在籍しています。\n\n「相手の気持ちをもっと深く知りたい」\n「復縁の可能性を見てもらいたい」\n「この恋を進めるべきか迷っている」\n\nそんな悩みに寄り添いながら、あなたに必要な言葉を届けてくれるでしょう。",
      "白の魔女ルミナの占いを読んでくださったあなたへ。もし今、本当に大切な答えを求めているなら、専門の鑑定師に相談してみるのもひとつの方法です。",
    ],
    pull: "「誰にも話せなかった悩みを聞いてほしい」「この恋の未来を知りたい」——そんな夜のための場所として、ご紹介します。",
    ctaLabel: "電話占いウィルを覗いてみる",
  },
];

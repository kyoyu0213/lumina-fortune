...
const lastRevisedAt = "2026年3月14日";
...
const sections: PrivacySection[] = [
  {
    ...
    items: [
      ...
      "プロフィール登録時にユーザーが入力した情報（ニックネーム・生年月日・血液型・性別など）。これらの情報は当運営者のサーバーに保存されます。",
      "本サービスへのアクセス日時・利用環境（ブラウザの種類、OSの種類、IPアドレスなど）",
      "Cookieおよびこれに類する技術により取得した利用履歴・行動履歴",
      "来訪日数の記録（白の贈り物機能のため、Cookieまたはローカルストレージにより訪問日数を記録しています）",
    ],
    note: "本サービスは一部機能を会員登録なしでご利用いただけますが、プロフィール登録時には上記の情報をご提供いただきます。氏名・住所・電話番号・メールアドレス等の直接的な個人識別情報を収集することを目的としていません。チャットへの入力は匿名で行っていただけます。ただし、ユーザーが自ら個人情報を入力した場合、当運営者はその情報を取得することがあります。",
  },
  {
    title: "第2条（情報の利用目的）",
  ...
  },
  {
    ...
    body: [
      ...
      "本サービスは、認証・データベース機能にSupabase, Inc.のサービスを利用しています。プロフィール情報等のデータはSupabaseのサーバーに保存されます。",
      "個人鑑定は、外部プラットフォーム（ココナラ等）を通じて受付・決済を行います。当該プラットフォームに提供される情報は、各サービスのプライバシーポリシーに従います。",
      "センシティブな個人情報（氏名・住所・電話番号・金融情報・健康情報など）はチャットに入力しないようにしてください。",
    ],
  },
  {
    title: "第5条（会員登録・プロフィール情報）",
    body: ["本サービスでは、より精度の高い鑑定をお届けするために、プロフィール情報の登録機能を提供しています。"],
    items: [
      "ユーザーは、ニックネーム・生年月日等のプロフィール情報を任意で登録できます。",
      "プロフィール情報は、当運営者のサーバー（Supabase）に保存されます。",
      "登録された情報の正確性については、ユーザーご自身の責任となります。",
      "ユーザーは、設定画面の削除ボタンからプロフィール情報を自身で削除できます。",
      "削除されたデータは復元できません。",
    ],
  },
  {
  ...
  {
    title: "第7条（アクセス解析ツールの使用）",
    body: [
      "本サービスでは、アクセス解析ツールを使用する場合があります。これらのツールはCookieを使用してトラフィックデータを収集しますが、このデータは匿名で収集されており、個人を特定するものではありません。この機能はCookieを無効にすることで収集を拒否することができます。",
    ],
  },
  {
    title: "第8条（情報の管理・保護）",
  ...
  },
  {
    title: "第9条（データの保存期間）",
    body: [
      "当運営者は、収集した情報を、利用目的の達成に必要な期間に限り保存します。利用目的を達成した情報は、合理的な期間内に削除または匿名化します。",
      "ユーザーは、設定画面からプロフィール情報を削除できます。削除の操作により、サーバー上の該当データは速やかに削除されます。削除されたデータは復元できませんのでご注意ください。",
    ],
  },
  {
    title: "第10条（未成年者のプライバシー）",
    body: [
      "本サービスは、18歳未満の方からの個人情報を意図的に収集することはありません。18歳未満の方がサービスをご利用になる場合は、保護者の方の同意および監督のもとでご利用ください。",
    ],
  },
  {
...
export const metadata: Metadata = {
  title: "プライバシーポリシー | 白の館 LUMINA",
  description: "白の館 LUMINAのプライバシーポリシーです。",
};
...
export default function PrivacyPage() {
  return (
    <PageShell
      title="プライバシーポリシー"
      description="白の館 LUMINAにおける個人情報の取り扱いについてご案内します。"
      backHref="/"
      backLabel="トップへ戻る"
    >
      <GlassCard className="space-y-6 text-sm leading-relaxed text-[#544c42]">
        <section className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p>最終改定日：{lastRevisedAt}</p>
          </div>
          <p>
            「白の館 LUMINA」（以下「本サービス」といいます）の運営者（以下「当運営者」といいます）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めます。本プライバシーポリシーは、本サービスにおける個人情報の取り扱いについて定めるものです。
          </p>
        </section>
